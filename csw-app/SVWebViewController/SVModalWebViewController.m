...
- (instancetype)initWithPdfData:(NSData *)data{
    self.webViewController = [[SVWebViewController alloc] initWithPdfData:data];
    if (self = [super initWithRootViewController:self.webViewController]) {
        UIBarButtonItem *doneButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone
                                                                                    target:self.webViewController
                                                                                    action:@selector(doneButtonTapped:)];
...
-(instancetype)initWithBlank{
    self.webViewController = [[SVWebViewController alloc] initWithBlank];
    if (self = [super initWithRootViewController:self.webViewController]) {
        UIBarButtonItem *doneButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone
                                                                                    target:self.webViewController
                                                                                    action:@selector(doneButtonTapped:)];
...
-(void) loadData:(NSData *)data {
    [self.webViewController loadData:data];
}
