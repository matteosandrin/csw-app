...
-(void) startIndicator{
    ...
    [ac setCenter:self.webView.center];
    NSLog(@" %f %f %f %f",ac.frame.size.width,ac.frame.size.height,ac.frame.origin.x,ac.frame.origin.y);
    [self.webView addSubview:ac];
    [ac startAnimating];
}
