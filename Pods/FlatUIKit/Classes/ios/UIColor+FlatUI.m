...
+ (UIColor *) lightCSWBlueColor {
    static UIColor *lightCSWBlue = nil;
    static dispatch_once_t lightCSWBlueToken;
    
    dispatch_once(&lightCSWBlueToken, ^{
        lightCSWBlue = [UIColor colorFromHexCode:@"409EF2"];
    });
    
    return lightCSWBlue;
}

+ (UIColor *) darkCSWBlueColor {
    static UIColor *darkCSWBlue = nil;
    static dispatch_once_t darkCSWBlueToken;
    
    dispatch_once(&darkCSWBlueToken, ^{
        darkCSWBlue = [UIColor colorFromHexCode:@"006095"];
    });
